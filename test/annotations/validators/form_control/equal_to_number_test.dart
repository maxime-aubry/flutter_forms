  ...
  group('Annotations > Validators > FormControl<TProperty> > EqualToNumber.',
    ...
    group('Valid.', () {
      test('value equals valueToCompare.', () async {
        ...
        EqualToNumber validator = EqualToNumber(valueToCompare: 0, error: null);
      ...
      test('value and valueToCompare are null.', () async {
        ...
        FormControl<num> formControl =
            root.controls['child'] as FormControl<num>;
        EqualToNumber validator = EqualToNumber(
          valueToCompare: null,
          error: null,
        );
      ...
      test('valueToCompare is null.', () async {
        ...
        FormControl<num> formControl =
            root.controls['child'] as FormControl<num>;
        EqualToNumber validator =
            EqualToNumber(valueToCompare: null, error: null);
    ...
    group('Invalid.', () {
      test('value is smaller than valueToCompare.', () async {
        ...
        FormControl<num> formControl =
            root.controls['child'] as FormControl<num>;
        EqualToNumber validator = EqualToNumber(valueToCompare: 1, error: null);
